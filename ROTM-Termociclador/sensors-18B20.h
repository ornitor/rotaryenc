...
#define PINO_BARRAMENTO_ONEWIRE 4   // barramento onewire no D4 ok 
...
float erro_1[NUM_MAX_SENSORES];
float integral[NUM_MAX_SENSORES] ={0,0,0,0,0,0,0,0};
float tmax[NUM_MAX_SENSORES] ={0,0,0,0,0,0,0,0};
float tmin[NUM_MAX_SENSORES]={100,100,100,100,100,100,100,100};
float setpoint[NUM_MAX_SENSORES] = {36,21,21,21,21,21,21,21};
